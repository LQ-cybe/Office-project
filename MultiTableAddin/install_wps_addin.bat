...
set "SCRIPT_PATH=%~dp0scripts\install_wps_addin.ps1"
if not exist "%SCRIPT_PATH%" set "SCRIPT_PATH=%~dp0files\scripts\install_wps_addin.ps1"
echo ========================================
echo Running script:
echo   scripts\install_wps_addin.ps1
echo ========================================
echo.
