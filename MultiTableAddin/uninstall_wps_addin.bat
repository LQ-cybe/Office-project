...
set "SCRIPT_PATH=%~dp0scripts\uninstall_wps_addin.ps1"
if not exist "%SCRIPT_PATH%" set "SCRIPT_PATH=%~dp0files\scripts\uninstall_wps_addin.ps1"
echo ========================================
echo Running script:
echo   scripts\uninstall_wps_addin.ps1
echo ========================================
echo.
